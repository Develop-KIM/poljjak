...
- afterHtmlSections는 포트폴리오의 "개선 가능한 콘텐츠 섹션"만 포함합니다.
- 아래 개인정보 섹션은 절대 포함하지 마세요: 이름, 연락처, 전화번호, 이메일, GitHub/GitLab 주소, 생년월일, 주소, 사진.
  이 정보들은 Before(원본 PDF)에서 확인하면 되므로 After에 포함할 필요가 없습니다.
- 포함해야 하는 섹션: 자기소개, 기술스택, 경력, 프로젝트, 수상/자격증, 교육 등 개선 여지가 있는 콘텐츠 섹션.
- 이슈가 없는 섹션도 원문 그대로 HTML로 출력하세요. 콘텐츠 섹션을 생략하면 안 됩니다.
...
- 재직 중인 또는 과거 회사명이 등장하면 [회사명]으로 대체하세요.
